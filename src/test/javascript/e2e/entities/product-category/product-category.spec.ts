...
describe('ProductCategory e2e test', () => {
    ...
    it('should load ProductCategories', async () => {
        ...
        expect(await productCategoryComponentsPage.getTitle()).to.eq('foodStoreApp.productCategory.home.title');
    });
    ...
    it('should load create ProductCategory page', async () => {
        ...
        expect(await productCategoryUpdatePage.getPageTitle()).to.eq('foodStoreApp.productCategory.home.createOrEditLabel');
    ...
    it('should delete last ProductCategory', async () => {
        ...
        expect(await productCategoryDeleteDialog.getDialogTitle()).to.eq('foodStoreApp.productCategory.delete.question');
