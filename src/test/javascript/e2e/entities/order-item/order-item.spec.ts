...
describe('OrderItem e2e test', () => {
    ...
    it('should load OrderItems', async () => {
        ...
        expect(await orderItemComponentsPage.getTitle()).to.eq('foodStoreApp.orderItem.home.title');
    });
    ...
    it('should load create OrderItem page', async () => {
        ...
        expect(await orderItemUpdatePage.getPageTitle()).to.eq('foodStoreApp.orderItem.home.createOrEditLabel');
    ...
    /* it('should delete last OrderItem', async () => {
        ...
        expect(await orderItemDeleteDialog.getDialogTitle())
            .to.eq('foodStoreApp.orderItem.delete.question');
