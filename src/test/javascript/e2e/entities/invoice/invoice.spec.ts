...
describe('Invoice e2e test', () => {
    ...
    it('should load Invoices', async () => {
        ...
        expect(await invoiceComponentsPage.getTitle()).to.eq('foodStoreApp.invoice.home.title');
    });
    ...
    it('should load create Invoice page', async () => {
        ...
        expect(await invoiceUpdatePage.getPageTitle()).to.eq('foodStoreApp.invoice.home.createOrEditLabel');
    ...
    it('should delete last Invoice', async () => {
        ...
        expect(await invoiceDeleteDialog.getDialogTitle()).to.eq('foodStoreApp.invoice.delete.question');
