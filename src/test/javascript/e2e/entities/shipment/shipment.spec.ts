...
describe('Shipment e2e test', () => {
    ...
    it('should load Shipments', async () => {
        ...
        expect(await shipmentComponentsPage.getTitle()).to.eq('foodStoreApp.shipment.home.title');
    });
    ...
    it('should load create Shipment page', async () => {
        ...
        expect(await shipmentUpdatePage.getPageTitle()).to.eq('foodStoreApp.shipment.home.createOrEditLabel');
    ...
    /* it('should delete last Shipment', async () => {
        ...
        expect(await shipmentDeleteDialog.getDialogTitle())
            .to.eq('foodStoreApp.shipment.delete.question');
