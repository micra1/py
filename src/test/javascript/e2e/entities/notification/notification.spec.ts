...
describe('Notification e2e test', () => {
    ...
    it('should load Notifications', async () => {
        ...
        expect(await notificationComponentsPage.getTitle()).to.eq('foodStoreApp.notification.home.title');
    });
    ...
    it('should load create Notification page', async () => {
        ...
        expect(await notificationUpdatePage.getPageTitle()).to.eq('foodStoreApp.notification.home.createOrEditLabel');
    ...
    it('should delete last Notification', async () => {
        ...
        expect(await notificationDeleteDialog.getDialogTitle()).to.eq('foodStoreApp.notification.delete.question');
