...
describe('ProductOrder e2e test', () => {
    ...
    it('should load ProductOrders', async () => {
        ...
        expect(await productOrderComponentsPage.getTitle()).to.eq('foodStoreApp.productOrder.home.title');
    });
    ...
    it('should load create ProductOrder page', async () => {
        ...
        expect(await productOrderUpdatePage.getPageTitle()).to.eq('foodStoreApp.productOrder.home.createOrEditLabel');
    ...
    /* it('should delete last ProductOrder', async () => {
        ...
        expect(await productOrderDeleteDialog.getDialogTitle())
            .to.eq('foodStoreApp.productOrder.delete.question');
